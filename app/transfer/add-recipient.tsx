...
export default function AddRecipientScreen() {
  ...
  const handleContinue = () => {
    // Navigate to amount entry with the new recipient details
    router.push(`/transfer/amount?name=${accountName || 'New Recipient'}&account=${accountNumber}&bank=${bankName || 'Selected Bank'}`);
  };
    ...
    <SafeAreaView className="flex-1 bg-[#E5E5F5]" edges={['top']}>
      ...
      >
        ...
        <View className="mt-8 mb-6">
          <Text className="text-[#1F2C37] text-base font-semibold mb-3">Account number</Text>
          <TextInput
        ...
        {/* Bank Name */}
        <View className="mb-6">
          <Text className="text-[#1F2C37] text-base font-semibold mb-3">Bank Name</Text>
          <TouchableOpacity className="w-full h-16 bg-white border border-gray-200 rounded-2xl px-5 flex-row items-center justify-between">
